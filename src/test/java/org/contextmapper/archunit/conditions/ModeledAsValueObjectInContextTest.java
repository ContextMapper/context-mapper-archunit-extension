...
import static org.contextmapper.archunit.ContextMapperJMoleculesArchRules.valueObjectClassesShouldBeModeledInCml;

class ModeledAsValueObjectInContextTest {
    ...
    void check_WhenEntityIsModeled_ThenConditionIsFulfilled() {
        ...
        // when, then
        valueObjectClassesShouldBeModeledInCml(sampleContext).check(classes);
    }
    ...
    void check_WhenEntityIsNotModeled_ThenAddEvent() {
        // given
        JavaClasses classes = new ClassFileImporter()
                .importPackages("org.contextmapper.archunit.sample.samplevalueobject_notmodeled");
